...
public class MainActivity extends AppCompatActivity implements GLSurfaceView.Renderer {
    ...
    private static final float[] TILE = new float[]{ // x, y, s, t
            0f, 0f, 0f, 0f, // 左下
            0f, 256f, 0f, 1f, // 左上
            256f, 0f, 1f, 0f, // 右下
            256f, 256f, 1f, 1f, // 右上
    ...
    private static final String VERTEX_SHADER = String.format(
            "uniform mat4 %s;\n" +
                    ...
                    "    %s = %s;\n" +
                    "}",
            U_MVP_MATRIX, A_POSITION, A_TEXTURE_COORDINATES, V_TEXTURE_COORDINATES,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBitmap = loadBitmap(this, R.drawable.map);
    }
